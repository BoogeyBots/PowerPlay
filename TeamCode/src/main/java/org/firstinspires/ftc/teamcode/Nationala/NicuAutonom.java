...
@Autonomous(name = "Nicu Cel Viteaz", group = "Robot")
public class NicuAutonom extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(-64.6, 13.4, Math.toRadians(0.0)))
                .waitSeconds(0.5)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.5, intake::open)
                .waitSeconds(0.5)
                .lineToLinearHeading(new Pose2d(-57.3, 14.2, Math.toRadians(0.0)))
                .UNSTABLE_addTemporalMarkerOffset(0, glisieraModule::goDown)
                .UNSTABLE_addTemporalMarkerOffset(0, bratModule::autonom2)
                //.turn(Math.toRadians(32))
                .lineToLinearHeading(new Pose2d(-64.7, 12.6, Math.toRadians(0.0)))
                .waitSeconds(0.5)
                .UNSTABLE_addTemporalMarkerOffset(0, intake::close)
                .waitSeconds(0.5)
                .UNSTABLE_addTemporalMarkerOffset(0, bratModule::goUp)
