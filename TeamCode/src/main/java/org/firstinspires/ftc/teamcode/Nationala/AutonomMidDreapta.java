...
@Autonomous(name = "Dreapta_Nationala_Mid", group = "Robot")
public class AutonomMidDreapta extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineTo((new Vector2d(-38, 17.1)))
                .lineTo((new Vector2d(-44, 17.1)))
                .turn(Math.toRadians(124.38))
                .UNSTABLE_addTemporalMarkerOffset(0.5, glisieraModule::goMid)
                .lineToLinearHeading((new Pose2d(-42, 17.1, Math.toRadians(34))))
                .waitSeconds(0.5)
