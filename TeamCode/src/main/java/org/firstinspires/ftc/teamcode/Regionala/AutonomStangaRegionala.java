...
@Autonomous(name = "Stanga_Regionala", group = "Robot")
public class AutonomStangaRegionala extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(65.3, 13.6, Math.toRadians(180.0)))
                ...
                .turn(Math.toRadians(-32))
                //al treilea con
                /*.lineToLinearHeading(new Pose2d(64.5, 13.8, Math.toRadians(180.0)))//65.5, 13.8
                .UNSTABLE_addTemporalMarkerOffset(1,intake::close)
                .waitSeconds(1)
                .UNSTABLE_addTemporalMarkerOffset(1,bratModule::goUp)
                .waitSeconds(1)
